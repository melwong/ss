...
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Response;
...
class ResponseTest extends ResponseTestCase
{
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Response', $response);
    ...
    {
        $headerMock = $this->getMockBuilder('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\ResponseHeaderBag')->setMethods(['set'])->getMock();
