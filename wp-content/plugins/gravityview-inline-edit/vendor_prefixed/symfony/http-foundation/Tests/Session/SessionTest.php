...
namespace GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Tests\Session;
...
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
...
{
    /**
     * @var \GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityEdit\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
