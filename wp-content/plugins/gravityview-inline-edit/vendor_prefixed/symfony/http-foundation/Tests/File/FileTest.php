...
class FileTest extends TestCase
{
    ...
    public function testMove()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\File\File', $movedFile);
    ...
    {
        $guesser = $this->getMockBuilder('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesserInterface')->getMock();
        $guesser
            ->expects($this->once())
            ->method('guess')
