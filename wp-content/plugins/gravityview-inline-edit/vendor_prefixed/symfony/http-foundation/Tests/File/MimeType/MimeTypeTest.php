...
namespace GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Tests\File\MimeType;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser;
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\File\MimeType\MimeTypeGuesser;
...
class MimeTypeTest extends TestCase
{
    ...
    {
        $this->expectException('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\File\Exception\FileNotFoundException');
    ...
    public function testGuessWithNonReadablePath()
    {
        ...
        if ('0333' == substr(sprintf('%o', fileperms($path)), -4)) {
            $this->expectException('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\File\Exception\AccessDeniedException');
