...
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Request;
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Session\Session;
use GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
class RequestTest extends TestCase
{
    ...
    {
        $this->expectException('GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException');
        $request = new Request();
    ...
    {
        $class = new \ReflectionClass('GravityKit\\GravityEdit\\Symfony\\Component\\HttpFoundation\\Request');
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "GravityKit\GravityEdit\Symfony\Component\HttpFoundation\Request::setTrustedHeaderName()" method is deprecated since Symfony 3.3 and will be removed in 4.0. Use the $trustedHeaderSet argument of the Request::setTrustedProxies() method instead.
     */
