...
final class Cron {
	...
	/**
	 * @var \GravityKit\GravityEdit\Foundation\ThirdParty\TrustedLogin\Config
	 */
	private $config;
	...
	/**
	 * @var null|\GravityKit\GravityEdit\Foundation\ThirdParty\TrustedLogin\Logging $logging
	 */
	private $logging;
