 ...
 */
namespace GravityKit\GravityEdit\Katzgrau\KLogger;

use DateTime;
use RuntimeException;
use GravityKit\GravityEdit\Psr\Log\AbstractLogger;
 ...
 *
 * Usage:
 * $log = new GravityKit\GravityEdit\Katzgrau\KLogger\Logger('/var/log/', GravityKit\GravityEdit\Psr\Log\LogLevel::INFO);
