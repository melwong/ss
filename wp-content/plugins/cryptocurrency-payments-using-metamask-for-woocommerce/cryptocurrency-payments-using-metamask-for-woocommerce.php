...
if (!class_exists('cpmw_metamask_pay')) {
    final class cpmw_metamask_pay
    {
        ...
        public function registers()
        {
            ...
            add_action('wp_ajax_nopriv_cpmw_save_transaction', array('CPMW_CONFIRM_TRANSACTION', 'cpmw_save_transaction'));
            add_action('wp_ajax_cpmw_save_transaction', array('CPMW_CONFIRM_TRANSACTION', 'cpmw_save_transaction'));            
            add_action('wp_ajax_nopriv_cpmw_cancel_order', array('CPMW_CONFIRM_TRANSACTION', 'cpmw_cancel_order'));
            add_action('wp_ajax_cpmw_cancel_order', array('CPMW_CONFIRM_TRANSACTION', 'cpmw_cancel_order'));
