...
use GravityKit\GravityCharts\Foundation\ThirdParty\TrustedLogin\Admin as TrustedLoginAdmin;
use GravityKit\GravityCharts\Foundation\ThirdParty\TrustedLogin\Form as TrustedLoginForm;
use GravityKit\GravityCharts\Foundation\ThirdParty\TrustedLogin\SupportUser as TrustedLoginSupportUser;
use GravityKit\GravityCharts\Foundation\ThirdParty\TrustedLogin\SiteAccess as TrustedLoginSiteAccess;
use GravityKit\GravityCharts\Foundation\ThirdParty\TrustedLogin\Logging as TrustedLoginLogging;
use GravityKit\GravityCharts\Foundation\ThirdParty\TrustedLogin\Config as TrustedLoginConfig;
use GravityKit\GravityCharts\Foundation\ThirdParty\TrustedLogin\Client as TrustedLoginClient;
...
class TrustedLogin {
	...
	public function add_gk_submenu_item() {
		...
		$page_title = $menu_title = esc_html__( 'Grant Support Access', 'gk-gravitycharts' );
	...
	public function get_config() {
		...
		$capabilities = apply_filters( 'gk/foundation/integrations/trustedlogin/capabilities', [
			'add'    => [
				'gravityview_full_access' => esc_html__( 'We need access to Views to provide great support.', 'gk-gravitycharts' ),
				'gform_full_access'       => esc_html__( 'We will need to see and edit the forms, entries, and Gravity Forms settings to debug issues.', 'gk-gravitycharts' ),
				'install_plugins'         => esc_html__( 'We may need to manage plugins in order to debug conflicts on your site and add related GravityView functionality.', 'gk-gravitycharts' ),
				'update_plugins'          => '',
				'deactivate_plugins'      => '',
				'activate_plugins'        => '',
			],
			'remove' => [
				'manage_woocommerce' => strtr(
					esc_html_x( "We don't need to see your [plugin] details to provide support (if [plugin] is enabled).", 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
					[ 'plugin' => 'WooCommerce' ]
				),
