...
namespace GravityKit\GravityCharts\Foundation;

use GravityKit\GravityCharts\Foundation\Integrations\GravityForms;
use GravityKit\GravityCharts\Foundation\Integrations\HelpScout;
use GravityKit\GravityCharts\Foundation\Integrations\TrustedLogin;
use GravityKit\GravityCharts\Foundation\WP\AdminMenu;
use GravityKit\GravityCharts\Foundation\Logger\Framework as LoggerFramework;
use GravityKit\GravityCharts\Foundation\WP\AjaxRouter;
use GravityKit\GravityCharts\Foundation\CLI\CLI;
use GravityKit\GravityCharts\Foundation\WP\PluginActivationHandler;
...
use GravityKit\GravityCharts\Foundation\Translations\Framework as TranslationsFramework;
use GravityKit\GravityCharts\Foundation\Encryption\Encryption;
use GravityKit\GravityCharts\Foundation\Helpers\Core as CoreHelpers;
use GravityKit\GravityCharts\Foundation\Helpers\Arr;
use GravityKit\GravityCharts\Foundation\WP\RESTController;
...
HTML;
				...
				$general_settings = array_merge(
					...
					[
						[
							...
							'title'       => esc_html__( 'Group GravityKit Products', 'gk-gravitycharts' ),
							'description' => esc_html__( 'Aggregate all GravityKit products into a single entry on the Plugins page for a cleaner view and easier management.', 'gk-gravitycharts' ),
						],
						[
							...
							'choices'     => $top_level_menu_action_choices,
							'title'       => esc_html__( 'GravityKit Menu Item Action', 'gk-gravitycharts' ),
							'description' => esc_html__( 'Open the selected page when clicking the GravityKit menu item.', 'gk-gravitycharts' ),
						],
						[
							'id'          => 'powered_by',
							'type'        => 'checkbox',
							'value'       => Arr::get( $gk_settings, 'powered_by', $default_settings['powered_by'] ),
							'title'       => esc_html__( 'Display "Powered By" Link', 'gk-gravitycharts' ),
							'description' => esc_html__( 'A "Powered by GravityKit" link will be displayed below some GravityKit products. Help us spread the word!', 'gk-gravitycharts' ),
						],
						[
							'id'          => 'affiliate_id',
							'type'        => 'number',
							'value'       => Arr::get( $gk_settings, 'affiliate_id' ),
							'title'       => esc_html__( 'Affiliate ID', 'gk-gravitycharts' ),
							'description' => strtr(
								esc_html_x( 'Earn money when people clicking your links become GravityKit customers. [link]Register as an affiliate[/link]!', 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
								[
						...
						[
							...
							'title'       => esc_html__( 'Become a Beta Tester', 'gk-gravitycharts' ),
							'description' => esc_html__( 'You will have early access to the latest GravityKit products. There may be bugs! If you encounter an issue, report it to help make GravityKit products better!', 'gk-gravitycharts' ),
						],
					]
				);
				...
				$support_settings = [
					[
						...
						'title'       => esc_html__( 'Support Email', 'gk-gravitycharts' ),
						'description' => esc_html__( 'In order to provide responses to your support requests, please provide your email address.', 'gk-gravitycharts' ),
						'validation'  => [
							[
								'rule'    => 'required',
								'message' => esc_html__( 'Support email is required', 'gk-gravitycharts' ),
							],
							[
								'rule'    => 'email',
								'message' => esc_html__( 'Please provide a valid email address', 'gk-gravitycharts' ),
							],
						],
					],
					[
						...
						'title'       => esc_html__( 'Show Support Port', 'gk-gravitycharts' ),
						'description' => ( esc_html__( 'The Support Port provides quick access to how-to articles and tutorials. For administrators, it also makes it easy to contact support.', 'gk-gravitycharts' ) .
						                   strtr(
							                   esc_html_x( '[image]Support Port icon[/image]', 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
							                   [
				...
				$technical_settings = [
					[
						...
						'title'       => esc_html__( 'Enable No-Conflict Mode', 'gk-gravitycharts' ),
						'description' => esc_html__( 'No-conflict mode prevents extraneous scripts and styles from being printed on GravityKit admin pages, reducing conflicts with other plugins and themes.', 'gk-gravitycharts' ),
					],
				];
				...
				$all_settings = [
					self::ID => [
						...
						'sections' => [
							[
								'title'    => esc_html__( 'General', 'gk-gravitycharts' ),
								'settings' => $general_settings,
							],
							[
								'title'    => esc_html__( 'Support', 'gk-gravitycharts' ),
								'settings' => $support_settings,
							],
							[
								'title'    => esc_html__( 'Technical', 'gk-gravitycharts' ),
	...
	public function get_foundation_information(): array {
		...
		$source_plugin_name = $source_plugin['Name'] ?? __( 'Unknown Plugin', 'gk-gravitycharts' );
		$loaded_by_message  = strtr(
			_x( 'GravityKit Foundation [version] (loaded by [plugin]).', 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
			[
				'[version]' => $version,
