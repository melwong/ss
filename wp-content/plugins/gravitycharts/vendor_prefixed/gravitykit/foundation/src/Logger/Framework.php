...
use GravityKit\GravityCharts\Foundation\ThirdParty\Monolog\Handler\ChromePHPHandler;
use GravityKit\GravityCharts\Foundation\ThirdParty\Monolog\Handler\StreamHandler;
...
use Exception;
use GravityKit\GravityCharts\Foundation\ThirdParty\Psr\Log\LoggerInterface;
use GravityKit\GravityCharts\Foundation\ThirdParty\Psr\Log\LoggerTrait;
...
CSS;
		...
		$query_monitor_notice = strtr(
			esc_html_x( 'You must install [link]Query Monitor[/link] WordPress plugin to use this option.', 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
			[
		...
		$chrome_logger_tip = strtr(
			esc_html_x( 'You must install [link]Chrome Logger[/link] browser extension to use this option.', 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
			[
		...
		$gravity_forms_logger_tip = strtr(
			esc_html_x( 'Logging is currently handled by [link]Gravity Forms[/link].', 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
			[
...
HTML;
		...
		$logger_settings = array_merge( $logger_settings, [
			[
				'id'    => 'logger',
				'type'  => 'checkbox',
				'title' => esc_html__( 'Enable Logging', 'gk-gravitycharts' ),
				'value' => $logger,
			],
			[
				'id'          => 'logger_type',
				'type'        => 'select',
				'title'       => esc_html__( 'Log Type', 'gk-gravitycharts' ),
				'description' => esc_html__( 'Where to store log output.', 'gk-gravitycharts' ),
				'value'       => $logger_type,
				'choices'     => [
					[
						'title' => esc_html__( 'File', 'gk-gravitycharts' ),
						'value' => 'file',
					],
					[
						'title' => esc_html__( 'Query Monitor', 'gk-gravitycharts' ),
						'value' => 'query_monitor',
					],
					[
						'title' => esc_html__( 'Chrome Logger', 'gk-gravitycharts' ),
						'value' => 'chrome_logger',
					],
				],
				'requires'    => [
		...
		$download_notice = strtr(
			esc_html_x( 'Download [link]log file[/link] ([size] / [date_modified]).', 'Placeholders inside [] are not to be translated.', 'gk-gravitycharts' ),
			[
