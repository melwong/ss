...
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Response;
...
class ResponseTest extends ResponseTestCase
{
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Response', $response);
    ...
    {
        $headerMock = $this->getMockBuilder('GravityKit\GravityCharts\Symfony\Component\HttpFoundation\ResponseHeaderBag')->setMethods(['set'])->getMock();
