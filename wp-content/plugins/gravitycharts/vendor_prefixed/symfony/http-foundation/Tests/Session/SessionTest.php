...
namespace GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Tests\Session;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\Attribute\AttributeBag;
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\Flash\FlashBag;
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\Session;
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\SessionBagProxy;
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\Storage\MockArraySessionStorage;
...
{
    /**
     * @var \GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
     */
    protected $storage;

    /**
     * @var \GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\SessionInterface
     */
    protected $session;
    ...
    {
        $this->assertInstanceOf('GravityKit\\GravityCharts\\Symfony\\Component\\HttpFoundation\\Session\\Flash\\FlashBagInterface', $this->session->getFlashBag());
    }
    ...
    {
        $this->assertInstanceOf('GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag', $this->session->getMetadataBag());
    }
