...
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
...
class RequestTest extends TestCase
{
    ...
    {
        $this->expectException('GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException');
        $request = new Request();
    ...
    {
        $class = new \ReflectionClass('GravityKit\\GravityCharts\\Symfony\\Component\\HttpFoundation\\Request');
    ...
    /**
     * @group legacy
     * @expectedDeprecation The "GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Request::setTrustedHeaderName()" method is deprecated since Symfony 3.3 and will be removed in 4.0. Use the $trustedHeaderSet argument of the Request::setTrustedProxies() method instead.
     */
