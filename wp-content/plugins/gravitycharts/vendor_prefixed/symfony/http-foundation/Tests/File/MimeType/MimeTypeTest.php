...
namespace GravityKit\GravityCharts\Symfony\Component\HttpFoundation\Tests\File\MimeType;

use PHPUnit\Framework\TestCase;
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\File\MimeType\FileBinaryMimeTypeGuesser;
...
class MimeTypeTest extends TestCase
{
    ...
    public function testGuessWithNonReadablePath()
    {
        ...
        if ('0333' == substr(sprintf('%o', fileperms($path)), -4)) {
            $this->expectException('GravityKit\GravityCharts\Symfony\Component\HttpFoundation\File\Exception\AccessDeniedException');
