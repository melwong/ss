...
use GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\Arr;
use GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\Str;
use GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\Fluent;
use GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\MessageBag;
use GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Container\Container;
use GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator;
use GravityKit\GravityCharts\Symfony\Component\HttpFoundation\File\UploadedFile;
use GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Container\Container
     */
    protected $container;
     ...
     *
     * @var \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    protected $messages;
     ...
     *
     * @param  \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return void
     *
     * @throws \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Validation\ValidationException
     */
     ...
     *
     * @return \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Translation\Translator
     */
     ...
     *
     * @param  \GravityKit\GravityCharts\Foundation\ThirdParty\Illuminate\Contracts\Container\Container  $container
     * @return void
     */
