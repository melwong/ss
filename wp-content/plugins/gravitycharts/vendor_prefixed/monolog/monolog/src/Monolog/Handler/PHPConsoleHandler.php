...
namespace GravityKit\GravityCharts\Foundation\ThirdParty\Monolog\Handler;

use Exception;
use GravityKit\GravityCharts\Foundation\ThirdParty\Monolog\Formatter\LineFormatter;
use GravityKit\GravityCharts\Foundation\ThirdParty\Monolog\Logger;
 ...
 *
 *      $logger = new \GravityKit\GravityCharts\Foundation\ThirdParty\Monolog\Logger('all', array(new \GravityKit\GravityCharts\Foundation\ThirdParty\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('GravityKit\\GravityCharts\\Foundation\\ThirdParty\\Monolog\\'), // array Hide calls of classes started with...
