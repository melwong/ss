...
class WOOMULTI_CURRENCY_F_Admin_Product {
	...
	public function simple_price_input() {
		...
		$regular_price = $this->adjust_fixed_price( json_decode( $wc_product->get_meta('_regular_price_wmcp', true ), true ) );
		$sale_price    = $this->adjust_fixed_price( json_decode( $wc_product->get_meta('_sale_price_wmcp', true ), true ) );
		foreach ( $currencies as $currency ) {
			if ( $currency != $this->settings->get_default_currency() ) {
				?>
	...
	public function variation_price_input( $loop, $variation_data, $variation ) {
		...
		$regular_price       = $this->adjust_fixed_price( json_decode( $variation_product->get_meta('_regular_price_wmcp', true ), true ) );
		$sale_price          = $this->adjust_fixed_price( json_decode( $variation_product->get_meta('_sale_price_wmcp', true ), true ) );
